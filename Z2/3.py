...
plt.pie(y, colors=mycolours, autopct='%1.1f%%', startangle=20, labels=labels, shadow=True)
plt.title('Ilośc mieszkań na rynku pierwotnym w 2018 roku')
plt.legend(loc='lower left')
plt.figure(2)
mycolours = ["red", "orange", "cyan", "white", "blue", "green"]  # kolory
plt.pie(y2, colors=mycolours, autopct='%1.1f%%', startangle=20, labels=labels, shadow=True)
